...
- `static/index.html`: Vue 3 + Tailwind v4, vendored, no build step. Search fires 120 ms after the last keystroke,
  ...
  Colors are [Everforest](https://github.com/sainnhe/everforest) as shipped by [Omarchy](https://omarchy.org) (dark medium, dark only); all tokens sit in one `:root` block at the top of the file.
